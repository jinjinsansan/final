      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {activeTab === 'home' && (
          <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center bg-gradient-to-b from-orange-50 to-yellow-50">
            <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-md mb-10">
              <Heart className="w-14 h-14 text-orange-400" />
            </div>
            <h1 className="text-[42px] font-jp-bold text-gray-900 mb-6">かんじょうにっき</h1>
            <p className="text-lg font-jp-medium text-gray-700 mb-16">自己肯定感を育てる感情日記アプリ</p>
            <button
            ...
            <p className="mt-28 text-xs text-gray-500 font-jp-normal">一般社団法人NAMIDAサポート協会</p>
          </div>
        )}
